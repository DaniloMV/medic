 ...
 */
class Lomedic_Registration_Block_Rewrite_Adminhtml_Customer_Edit_Tab_Addresses extends Mage_Adminhtml_Block_Customer_Edit_Tab_Addresses
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('registration/customer/addresses.phtml');
    }
    
    /**
     * 
     * @return typeGet region url
     */
