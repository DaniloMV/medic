...
class Mage_Core_Model_Email_Template extends Mage_Core_Model_Email_Template_Abstract
{
	...
	*/
    ...
    public function getMail(){
           if (is_null($this->_mail)) {
            $my_smtp_host = 'smtp.gmail.com';//Mage::getStoreConfig('system/smtp/host');
            $my_smtp_port = Mage::getStoreConfig('system/smtp/port');
            $config = array(
			'port'=>'587',                                              
			'auth' => 'login',         
			'ssl' => 'tls',				
                        'username' => 'perlacrv@gmail.com', 
                        'password' => 'peas1912*'                                               
			);
//Builder.Bot@Softeq.com
//h62%25Qs
            Mage::log("Enviando correo electronico ->".$this->_mail);
